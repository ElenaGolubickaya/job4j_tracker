...
public class ProductLabelTest {
    ...
    @Test
    public void whenGenerateLabels() {
        ...
        List<String> expented = Arrays.asList(one.toString(), two.toString(), three.toString(), four.toString());
        assertThat(strings).containsAll(expented);
    }
}